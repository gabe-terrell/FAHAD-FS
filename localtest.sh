...
function simulate {
	NODE_ADDITIONS="$(($RANDOM % ($MAX_ADDITIONS - $MIN_ADDITIONS) + $MIN_ADDITIONS))"
	UPLOADS="$(($RANDOM % ($MAX_UPLOADS - $MIN_UPLOADS) + $MIN_UPLOADS))"
	DOWNLOADS="$(($RANDOM % ($MAX_DOWNLOADS - $MIN_DOWNLOADS) + $MIN_DOWNLOADS))"
